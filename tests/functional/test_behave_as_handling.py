...
lettuce_abs_path = lambda *x: fs.abspath(join(lettuce_dir, *x)).replace('\\', '/')
...
def test_failing_tables_behave_as_feature():
    ...
    if platform.system() != "Windows":
        ...
        assert_stdout_lines_with_traceback(
            ...
            '\n'
            '  Scenario: Regular numbers                        # tests/functional/behave_as_features/3rd_failing_steps/3rd_failing_steps.feature:6\n'
            '    Given I have entered 10 into the calculator    # tests/functional/behave_as_features/3rd_failing_steps/failing_step_definitions.py:12\n'
            '    Traceback (most recent call last):\n'
            '      File "%(lettuce_core_file)s", line %(call_line)d, in __call__\n'
            '        ret = self.function(self.step, *args, **kw)\n'
            '      File "%(step_file)s", line 13, in i_have_entered_NUM_into_the_calculator\n'
            '        assert False, \'Die, die, die my darling!\'\n'
            '    AssertionError: Die, die, die my darling!\n'
            '    And I have entered 4 into the calculator       # tests/functional/behave_as_features/3rd_failing_steps/failing_step_definitions.py:12\n'
            '    When I press multiply                          # tests/functional/behave_as_features/3rd_failing_steps/failing_step_definitions.py:17\n'
            '    Then the result should be 40 on the screen     # tests/functional/behave_as_features/3rd_failing_steps/failing_step_definitions.py:21\n'
            '\n'
            '  Scenario: Shorter version of the scenario above  # tests/functional/behave_as_features/3rd_failing_steps/3rd_failing_steps.feature:12\n'
            '    Given I multiply 10 and 4 into the calculator  # tests/functional/behave_as_features/3rd_failing_steps/failing_step_definitions.py:25\n'
            '    Traceback (most recent call last):\n'
            '      File "%(lettuce_core_file)s", line %(call_line)d, in __call__\n'
            '        ret = self.function(self.step, *args, **kw)\n'
            '      File "%(step_file)s", line 29, in multiply_X_and_Y_into_the_calculator\n'
            ...
            '  Scenario: Shorter version of the scenario above  # tests/functional/behave_as_features/3rd_failing_steps/3rd_failing_steps.feature:12\n'
            '\n' % {
                    'lettuce_core_file': lettuce_abs_path('core.py'),
                    'step_file': lettuce_abs_path('..', 'tests', 'functional', 'behave_as_features', '3rd_failing_steps', 'failing_step_definitions.py'),
                    'call_line':call_line,
                }
        )
